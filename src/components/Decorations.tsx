...
export function FlowerRow({ className = '' }: { className?: string }) {
  // 9 flowers, evenly spaced in viewBox -150-650, smaller size to all fit
  const flowers = [
    { x: -150, y: 35, r: 90, color: '#86d1edff', size: 0.7 },
    { x: -50, y: 35, r: 90, color: '#eb8b95ff', size: 0.7 },
    { x: 50, y: 35, r: 90, color: '#ebafc9ff', size: 0.7 },
    { x: 150, y: 30, r: 45, color: '#D4908A', size: 0.65 },
    { x: 250, y: 36, r: 150, color: '#A99BB8', size: 0.7 },
    { x: 350, y: 30, r: 0, color: '#E8A8A0', size: 0.65 },
    { x: 450, y: 35, r: 60, color: '#E8C97A', size: 0.7 },
    { x: 550, y: 30, r: 120, color: '#99c69aff', size: 0.65 },
    { x: 650, y: 35, r: 180, color: '#c2a1d8ff', size: 0.7 },
  ]
