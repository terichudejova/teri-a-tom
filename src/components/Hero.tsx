  ...
  return (
    <section id="hero" className="relative min-h-screen bg-cream overflow-hidden">
      ...
      <div className="relative z-10 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto" style={{ paddingTop: 'calc(29vw + 2rem)' }}>
        <FlowerRow className="relative z-10 opacity-70 -mt-8 mb-2 md:mt-0 md:mb-8 scale-125 md:scale-100" />
        ...
        {/* 3-photo gallery */}
        <div className="flex gap-2 md:gap-3 h-[45vh] md:h-[55vh] lg:h-[60vh] max-w-4xl mx-auto mb-16 md:mb-20">
          {photos.map((photo, i) => (
            <div
              key={i}
              className="flex-1 rounded-2xl overflow-hidden shadow-2xl relative group cursor-pointer"
            >
              <img
                src={photo.src}
                alt={photo.alt}
              ...
              />
              {/* Glass overlay — full photo, single transition */}
              <div
              ...
              >
                <p className="text-white text-sm md:text-base font-light tracking-wide text-center px-6 drop-shadow">
                  {t.hero.photoCaptions[i]}
                </p>
              </div>
            </div>
          ))}
